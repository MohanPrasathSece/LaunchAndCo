        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl xl:text-6xl font-bold text-foreground mb-6 leading-tight">
              Senior Revenue Leadership.{" "}
              <span className="gradient-text">Without the Headcount Risk.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                asChild 
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-hover transition-smooth text-lg px-8"
              >
                <Link to="/how-we-work">
